...
const HomePage = () =>{
    ...
    <div>
        ...
        <img alt="Melodies" src="imgs/music.png" style={{position: 'absolute', top: '370px', left: '600px', width:'180px', height:'167px'}}/>
        <i className="fa-solid fa-file-video" style={{ fontSize: '2.5em', verticalAlign: 'middle' }} />

        <h2 style={{position: 'absolute', top: '370px', left: '600px', width:'180px', height:'167px', fontSize:'40px'}}>your musical buddy.</h2>

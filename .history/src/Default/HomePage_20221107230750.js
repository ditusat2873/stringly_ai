...
const HomePage = () =>{
    ...
    <div>
        ...
        <h2 style={{position: 'absolute', top: '370px', left: '868px', width:'700px', height:'167px', fontSize:'30px'}}> Play along you favorite music pieces, while stringly helps you play to correct note with the correct posture.</h2>

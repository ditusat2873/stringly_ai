                ...
                <div className="learnContentHelpPanel">
                    ...
                    <div className="parent">
                        ...
                        <div className="buttons child1 child2">
                            <div><p className="ptag" style={{width: "500px",position:"absolute", top: "-40px", left: "60px"}}>Use the Tuner to tune your stringed instrument. Click the Start button below to get started.</p></div>
                            <div></div>
                            <div></div>
                        </div>
                    </div>

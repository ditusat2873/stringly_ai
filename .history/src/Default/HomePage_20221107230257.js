...
const HomePage = () =>{
    ...
    <div>
        ...
        <h2 style={{position: 'absolute', top: '370px', left: '950px', width:'680px', height:'167px', fontSize:'40px'}}> Play along you favorite music pieces, while stringly helps you play to correct note with the correct posture.</h2>

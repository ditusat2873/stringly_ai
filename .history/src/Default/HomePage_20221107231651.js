...
const HomePage = () =>{
    ...
    <div>
        ...
        <i className="fa fa-music" style={{ position: 'absolute', top: '620px', left: '830px', fontSize: '2.5em', verticalAlign: 'middle' }} />
        <h2 style={{position: 'absolute', top: '620px', left: '870px', width:'700px', height:'167px', fontSize:'30px'}}> Let stringly help tune your violin.</h2>

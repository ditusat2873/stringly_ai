...
const HomePage = () =>{
    ...
    <div>
        ...
        <i className="fa-solid fa-file-video" style={{ position: 'absolute', top: '370px', left: '840px', fontSize: '2.5em', verticalAlign: 'middle' }} />
        <h2 style={{position: 'absolute', top: '370px', left: '870px', width:'700px', height:'167px', fontSize:'30px'}}> Play along you favorite music pieces, while stringly helps you play to correct note with the correct posture.</h2>

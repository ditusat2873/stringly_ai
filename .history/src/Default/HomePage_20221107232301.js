...
const HomePage = () =>{
    ...
    <div>
        ...
        <h2 style={{position: 'absolute', top: '370px', left: '870px', width:'700px', height:'167px', fontSize:'30px', color:'grey'}}> Play along your favorite music pieces, while stringly helps you play the correct note, with the correct posture.</h2>
        <i className="fa fa-leanpub" style={{ position: 'absolute', top: '520px', left: '820px', fontSize: '2.5em', verticalAlign: 'middle' }} />
        <h2 style={{position: 'absolute', top: '520px', left: '870px', width:'700px', height:'167px', fontSize:'30px', color:'grey'}}> Let stringly help practice your bowing and posture skills with exercises.</h2>
        <i className="fa fa-music" style={{ position: 'absolute', top: '620px', left: '820px', fontSize: '2.5em', verticalAlign: 'middle' }} />
        <h2 style={{position: 'absolute', top: '620px', left: '870px', width:'700px', height:'167px', fontSize:'30px', color:'grey'}}> Let stringly help tune your violin.</h2>
